...
namespace FOXALLIES\Packages\Router\SimpleRouter;

use Closure;
use Exception;
use FOXALLIES\Packages\Router\Exceptions\InvalidArgumentException;
use FOXALLIES\Packages\Router\Http\Middleware\BaseCsrfVerifier;
use FOXALLIES\Packages\Router\Http\Request;
use FOXALLIES\Packages\Router\Http\Response;
use FOXALLIES\Packages\Router\Http\Url;
use FOXALLIES\Packages\Router\SimpleRouter\ClassLoader\IClassLoader;
use FOXALLIES\Packages\Router\SimpleRouter\Exceptions\HttpException;
use FOXALLIES\Packages\Router\SimpleRouter\Handlers\CallbackExceptionHandler;
use FOXALLIES\Packages\Router\SimpleRouter\Handlers\IEventHandler;
use FOXALLIES\Packages\Router\SimpleRouter\Route\IGroupRoute;
use FOXALLIES\Packages\Router\SimpleRouter\Route\ILoadableRoute;
use FOXALLIES\Packages\Router\SimpleRouter\Route\IPartialGroupRoute;
use FOXALLIES\Packages\Router\SimpleRouter\Route\IRoute;
use FOXALLIES\Packages\Router\SimpleRouter\Route\RouteController;
use FOXALLIES\Packages\Router\SimpleRouter\Route\RouteGroup;
use FOXALLIES\Packages\Router\SimpleRouter\Route\RoutePartialGroup;
use FOXALLIES\Packages\Router\SimpleRouter\Route\RouteResource;
...
class SimpleRouter
{
     ...
     * Start routing
     *
     * @throws \FOXALLIES\Packages\Router\SimpleRouter\Exceptions\NotFoundHttpException
     * @throws \FOXALLIES\Packages\Router\Http\Middleware\Exceptions\TokenMismatchException
